...
//What I would do: I would map the arr, and add in the greeting property that way, i can use spread operator to include the existing properties

function sortByValueAndIndex(arr) {
  return arr.map((e) => ({ ...e, greeting: `Hi ${e.firstName}, what do you like the most about ${e.language}?` }));
}
